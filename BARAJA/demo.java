...
public class demo extends JPanel {
	...
	private void animation() {
		...
		if(x<10) {
		            if(jugador[a] > jugador[a+9] && jugador[a] > jugador[a+19] && jugador[a] > jugador[a+29]) { P[0]++;   
		        }else{
		            if(jugador[a+9] > jugador[a] && jugador[a+9] > jugador[a+19] && jugador[a+9] > jugador[a+29]) {P[1]++;
		         }else{
		             if(jugador[a+19] > jugador[a] && jugador[a+19] > jugador[a+9] && jugador[a+19] > jugador[a+29]){P[2]++;          	
		         }else {
		             if(jugador[a+29] > jugador[a] && jugador[a+29] > jugador[a+9] && jugador[a+29] > jugador[a+19])P[3]++;
		                }
		            }
		        }
		   }
	...
	public static void reparte() {
	   ...
	   public void paint(Graphics g){
			  ...
			  g.setColor(new Color(255, 255, 255));
			  g.setFont(new Font("times new roman",Font.BOLD,18)); 
			  g.drawString("P1: "+P[0], 705, 180); 
			  g.setColor(new Color(255, 255, 255));
			  g.setFont(new Font("times new roman",Font.BOLD,18)); 
			  g.drawString("P2: "+P[1], 705, 230); 
			  g.setColor(new Color(255, 255, 255));
			  g.setFont(new Font("times new roman",Font.BOLD,18));  
			  g.drawString("P3: "+P[2], 705, 280); 
			  g.setColor(new Color(255, 255, 255));
			  g.setFont(new Font("times new roman",Font.BOLD,18)); 
			  g.drawString("P4: "+P[3], 705, 330); 
			  			  
			  
			  if(x==0) {
			  int mayor=0, ubicacion=0;

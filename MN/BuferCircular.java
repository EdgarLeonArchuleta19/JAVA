...
{
   private final int[] bufer = { -1, -1, -1, -1, -1 }; // búfer compartido
   ...
   public synchronized void establecer( int valor ) throws InterruptedException
   {
      ...
      {
         System.out.printf( "Lavado está lleno. Automovilista espera.\n" );
      ...
      mostrarEstado( "Automovilista solicita servicio " + valor );
   ...
   public synchronized int obtener() throws InterruptedException
   {
      ...
      {
         System.out.printf( "Lavado esta vacio. Trabajadores esperan.\n" );
